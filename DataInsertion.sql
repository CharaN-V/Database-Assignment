...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2023 at 07:33 AM
...
INSERT INTO `employeetable` (`EmployeeID`, `Name`, `Role`, `Department`, `Mail`) VALUES
(34529, 'Charan', 'Architect', 'Design', 'cvayyeti@gmail.com'),
(89732, 'Bhuvana', 'Hr', 'Human Resources', 'bhuvanagogs@gmail.com'),
(32789, 'Pavan', 'Sales Anaylst', 'Marketing', 'PavanR@gmail.com'),
(63248, 'Venky', 'Manager', 'Structural Engineer', 'Venkyjv@gmail.com');
...
INSERT INTO `housingproject` (`ProjectName`, `Location`, `Size`, `Status`) VALUES
('Troy', 'New York', 350, 'Basic Structure Built'),
('Lexus', 'Texas', 270, 'Completed'),
('Trojan', 'Chicago', 300, 'Planned'),
('Meridius', 'California', 500, 'Final Inspection');
